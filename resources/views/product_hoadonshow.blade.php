...
@section('content')
<div class="container">
    <h2 class="h2_text">Thông tin chi tiết hóa đơn</h2>
    <div class="form-group">
        <label for="mahd">Mã</label>
        <input type="text" class="form-control" id="mahd" value="{{$['id']}}" name="mahd" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" id="trangthai" name="trangthai" value="{{$nv['trangthai']}}" min="0" max="1" required>
    </div>
    <div class="form-group">
